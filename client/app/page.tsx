...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-800 flex flex-col items-center justify-center mb-2  text-white">
     <main className="flex flex-col items-center justify-center flex-1 w-full px-4">
        ...
        <p className="text-lg md:text-xl mb-8">
          Use Our Advanced <span className="text-yellow-500 font-serif ">AI System</span>  to Self-Recommend Cars Without Being an Expert
        </p>
        </div>
